...
const getProductos = async (req, res) => {
  try {
    const { publicado, id_categoria, id, q, precio_min, precio_max, talla, color, bajo_stock, page, limit } = req.query;
    const data = await productosService.getProductos({ publicado, id_categoria, id, q, precio_min, precio_max, talla, color, bajo_stock, page, limit });
    res.json(data);
  } catch (err) {
