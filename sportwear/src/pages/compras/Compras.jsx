...
import './Compras.css';
import { IconCart, IconCheck, IconEye, IconPrint, IconSearch, IconX } from "../../components/Icons";
    ...
    <div className="compras-container">
      ...
      <div className="compras-actions-bar">
        ...
        <button
          ...
          onClick={() => { setForm({ proveedor: "", producto: "", cantidad: 1, total: "", estado: "Pendiente", fecha: "" }); setModal(true); }}
        >
