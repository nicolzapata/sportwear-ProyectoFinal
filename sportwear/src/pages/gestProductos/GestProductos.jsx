            ...
            <div className="gestproductos-modal-body gestproductos-factura-body">
              <div className="gestproductos-factura-seccion">
                ...
                <div className="gestproductos-detalle-info-grid">
                  ...
                  <div><span className="gestproductos-detalle-info-label">Destacado</span><span className="gestproductos-detalle-info-valor">{verDetalle.destacado === "Nuevo" ? "Nuevo" : verDetalle.destacado === "Promocion" ? "Promoción" : "Ninguno"}</span></div>
                </div>
              </div>
