          ...
          <tbody className="tbl-body">
            {filtrados.map((p) => (
              <tr key={p.id_proveedor} className="tbl-row">
                <td className="tbl-td"><span className="proveedores-empresa-name">{p.nombre_comercial || p.razon_social}</span></td>
                <td className="tbl-td"><code className="proveedores-nit-code">{p.numero_doc}</code></td>
