...
// variante="modal" (por defecto): overlay centrado, usado al crear un cliente.
// variante="panel": se acopla al lado de la tabla, usado al editar un cliente
...
export default function ClienteFormModal({
  ...
  if (variante === 'panel') {
    const nombreCompleto = `${clienteForm.nombres || ''} ${clienteForm.apellidos || ''}`.trim();
    return (
      <DetallePanel
        iniciales={getInitials(nombreCompleto) || '?'}
        avatarColor={getAvatarColor(editar)}
        nombre={editar ? "Editar cliente" : "Nuevo cliente"}
        ...
        footer={
          <>
            ...
            <button className="detalle-panel-btn-primario" onClick={handleGuardarCliente} disabled={guardandoModal}>
