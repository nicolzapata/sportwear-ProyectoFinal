...
import { MAX_MONTO, MAX_LONGITUD_TEXTO_LIBRE } from "../../../../shared/utils/numerico";
...
export default function NuevaVentaModal({
  ...
  return (
    <div className="pedidosventas-modal-overlay" onClick={() => !guardandoVenta && setModalVenta(false)}>
      <div className="pedidosventas-modal pedidosventas-modal-factura pedidosventas-modal-nueva" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="pedidosventas-modal-body">
          ...
          <div className="pedidosventas-items-section">
            ...
            <div className="pedidosventas-items-tabla-card">
          ...
          <div className="pedidosventas-form-resumen-row">
            <div>
              <div className="pedidosventas-form-row">
                <div className="pedidosventas-form-group">
            ...
            <div className="pedidosventas-resumen-card">
              <div className="pedidosventas-resumen-linea">
                <span>Subtotal:</span>
                <span>{fmt(subtotalVenta)}</span>
              </div>
              <div className="pedidosventas-resumen-linea pedidosventas-resumen-linea-descuento">
                <span>Descuento aplicado:</span>
                <span>- {fmt(formVenta.descuento)}</span>
              </div>
              {Number(formVenta.impuesto) > 0 && (
                <div className="pedidosventas-resumen-linea">
                  <span>Impuesto:</span>
                  <span>+ {fmt(formVenta.impuesto)}</span>
                </div>
              )}
              <hr className="pedidosventas-resumen-divisor" />
              <div className="pedidosventas-resumen-total">
                <span>Total:</span>
                <span className="pedidosventas-resumen-total-valor">{fmt(totalVenta)}</span>
              </div>
            </div>
          </div>
        </div>
        <div className="pedidosventas-modal-footer">
          ...
          <button className="pedidosventas-btn-primary" onClick={guardarVenta} disabled={guardandoVenta}>
            {guardandoVenta ? "Guardando..." : <><IconCheck /> Registrar venta</>}
          </button>
        </div>
      </div>
    </div>
