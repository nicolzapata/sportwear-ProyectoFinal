...
export function usePedidosVentas() {
  ...
  return {
    ...
    verDetalle, setVerDetalle, abonosModal, setAbonosModal,
    formAbono, setFormAbono, erroresAbono, setErroresAbono,
    filaAbierta, setFilaAbierta, cambiandoEstado, guardandoAbono,
    modalAnular, setModalAnular, motivoAnulacion, setMotivoAnulacion,
    clientes, productos, filtroOrigen, setFiltroOrigen,
    ...
    guardarVenta, totalPaginas, cambiarEstado, confirmarAnularVenta, agregarAbono,
  };
}
