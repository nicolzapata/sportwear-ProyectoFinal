...
// ── NUEVO: ícono propio para el listón de "Agotado" — mismo lenguaje visual
// que "Nuevo"/"Promoción" (ícono + texto en listón), pero con su propio
// color, ya que es una indicación distinta (no se puede comprar). ──
const IconAgotado = () => (
  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
