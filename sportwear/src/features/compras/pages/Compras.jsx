...
export default function Compras() {
  ...
  return (
    <div className="compras-container">
      ...
      <ComprasTable
        compras={compras} tienePerm={tienePerm}
        filaAbierta={filaAbierta} setFilaAbierta={setFilaAbierta}
        cambiandoEstadoTabla={cambiandoEstadoTabla} cambiarEstadoDesdeTabla={cambiarEstadoDesdeTabla}
        abrirDetalle={abrirDetalle} abrirEdicion={abrirEdicion}
        totalPaginas={totalPaginas} pagina={pagina} setPagina={setPagina} totalCompras={totalCompras}
      />

      <NuevaCompraModal
        modal={modal} setModal={setModal} guardando={guardando} guardar={guardar}
        form={form} setForm={setForm} errores={errores} setErrores={setErrores}
        proveedores={proveedores} productos={productos}
        actualizarItem={actualizarItem} agregarItem={agregarItem} quitarItem={quitarItem}
        toggleMismoPrecio={toggleMismoPrecio}
        subtotal={subtotal} totalCompra={totalCompra}
      />

      <CompraDetalleModal
        verDetalle={verDetalle} cerrarDetalle={cerrarDetalle} tienePerm={tienePerm}
        modoEdicion={modoEdicion} setModoEdicion={setModoEdicion}
        estadoEditado={estadoEditado} setEstadoEditado={setEstadoEditado}
        guardandoEstado={guardandoEstado} guardarEstado={guardarEstado}
      />
    </div>
  );
}
